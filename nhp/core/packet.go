...
func HeaderTypeToDeviceType(t int) int {
	...
	case NHP_KNK, NHP_LST, NHP_RKN, NHP_OTP, NHP_REG, NHP_ACC, NHP_EXT, NHP_DAR:
		return NHP_AGENT
	case NHP_ACK, NHP_AOP, NHP_LRT, NHP_COK, NHP_AAK, NHP_RAK, NHP_DAK, NHP_DAG, NHP_DBA:
		return NHP_SERVER
...
func (d *Device) CheckRecvHeaderType(t int) bool {
	...
	case NHP_SERVER:
		switch t {
		case NHP_REG, NHP_KNK, NHP_LST, NHP_RKN, NHP_EXT, NHP_ART, NHP_RLY, NHP_AOL, NHP_OTP, NHP_DRG, NHP_DAR, NHP_DOL:
			return true
		}
	case NHP_AC:
		switch t {
	...
	case NHP_DE:
		switch t {
		case NHP_DRG, NHP_DAG, NHP_DAK, NHP_DPC, NHP_DPV, NHP_DBA:
			return true
		}
	}
