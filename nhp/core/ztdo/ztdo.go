...
var lengthMap map[string]uint32
...
type Ztdo struct {
	...
	isHeaderParsed     bool // As indication, to restore the header when header is parsed
}
...
// Searilize Go struct into bytes buffer
...
// recursively deserialize binary data from a file into a Go struct
